...
export default function DashboardHowToUsePage() {
  return (
    <div className="space-y-8">
      ...
      <section className="overflow-hidden rounded-xl border border-line bg-ink text-white shadow-soft">
        <div className="grid gap-6 p-6 lg:grid-cols-[0.72fr_1.28fr] lg:p-8">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-teal-100">Builder mindset</p>
            ...
            <div className="mt-5 rounded-lg border border-white/10 bg-white/[0.08] p-4">
              <div className="flex items-start gap-3">
                <span className="rounded-md bg-teal-100 p-2 text-teal-900">
              ...
              return (
                <article key={step.step} className="rounded-lg border border-white/10 bg-white/[0.08] p-4">
                  <div className="flex items-center justify-between gap-3">
                    <span className="font-display text-sm font-bold text-teal-100">{step.step}</span>
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_360px]">
        <div className="rounded-lg border border-line bg-white p-5 shadow-crisp">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-teal-700">Tips</p>
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2">
            {howToUseTips.map((tip) => (
              <div key={tip} className="rounded-md border border-line bg-paper px-4 py-3 text-sm font-semibold leading-6 text-coal">
                {tip}
              </div>
            ))}
          </div>
        ...
        <aside className="rounded-lg border border-line bg-white p-5 shadow-crisp">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-teal-700">Recommended test</p>
